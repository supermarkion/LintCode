/*
    ...
    Link: http://www.lintcode.com/en/problem/interval-minimum-number/

    Example: For array [1,2,7,8,5], and queries [(1,2),(0,4),(2,4)], return [2,1,5]

    Solution: None

    Source: https://github.com/kamyu104/LintCode/blob/master/C%2B%2B/interval-minimum-number.cpp
*/
