/*
    ...
    Link: http://www.lintcode.com/en/problem/scramble-string/
    Example: 
    Solution: We apply the dynamic programming to solve this problem.
    Source:
        https://github.com/kamyu104/LintCode/blob/master/C++/scramble-string.cpp
